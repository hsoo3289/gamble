...
<title>Cash_Approve_List</title>
	<body>
	<center>
		<hr width='700' size='2' noshade>
			<h2>충전(승인) 리스트</h2>
		<hr width='700' size='2' noshade>
	  <table class="table table-striped table-bordered" border="1" width="600" align="center"  cellpadding="3" cellspacing="1" style="width: 702px;">		
			<tr>
			...
			<c:if test="${empty list}">
				...
				<tr>
					...
					<td align="center">${cash.seq}</td>
					<td align="center">${cash.cahring}</td>
